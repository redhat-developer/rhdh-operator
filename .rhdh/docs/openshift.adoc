...
To check that the dynamic plugins configuration has been loaded, append the following to your Red Hat Developer Hub root URL: `/api/extensions/loaded-plugins` and check the list of plugins:
