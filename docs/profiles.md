...
* Switching the default image base from [`quay.io/rhdh-community/operator`](https://quay.io/rhdh-community/operator) to [`quay.io/rhdh/rhdh-rhel10-operator`](https://quay.io/rhdh/rhdh-rhel10-operator) on `main` (RHEL 10). RHDH 1.y maintenance branches continue to use [`quay.io/rhdh/rhdh-rhel9-operator`](https://quay.io/rhdh/rhdh-rhel9-operator).
