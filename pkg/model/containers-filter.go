...
// getContainers returns a list of containers filtered by the names provided in the names array
// or by a string annotation containing comma-separated names.
